...
print(f"Config: altitude={altitude/1e3:.0f} km, T_orbita={T_orbita/60:.1f} min, B_ref={B_ref:.3e} T")
print(f"Auto k_bdot => {k_bdot:.3g} (candidato {('%.3g' % k_candidate) if 'k_candidate' in locals() else 'n/a'})")
